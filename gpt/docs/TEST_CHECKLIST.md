...
- [x] `git diff --check`。
- [x] package、lock、manifest、dist manifest、ZIP manifest 均为 3.0.0；ZIP/dist 文件名集合和文件内容逐一相同。
...
先按 `docs/OFFICIAL_NAVIGATION_SETUP.md` 安装 Yada 3.0 和原版 GPT Navigator Helper，并禁用其他导航插件。
